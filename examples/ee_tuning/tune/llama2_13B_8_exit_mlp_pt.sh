...
GROUP_NAME=llama-2-13B-chat-8-EXIT-pt
...
MODEL_HOME=
LOAD_PATH=${MODEL_HOME}/checkpoints/llama2-13b-chat-8-exit # your checkpoint path
...
GPT_ARGS="
    ...
    --swiglu \
    --exit-layer-nums 5 10 15 20 25 30 35 40 \
